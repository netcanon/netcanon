# Switchport mode: Cisco IOS-XE versus Arista EOS
...
Retrieved: 2026-04-30 (page returned 403 on direct fetch; syntax cross-confirmed via search excerpts and the Cisco IOS Interface and Hardware Component Command Reference)
...
The `switchport trunk encapsulation dot1q` keyword is required on
some older IOS platforms; Catalyst 9000 IOS-XE accepts dot1q
implicitly.
...
scope.  Cisco `switchport voice vlan` round-trips via
