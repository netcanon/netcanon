# Routing protocols (BGP / OSPF / EIGRP): Cisco IOS-XE versus Arista EOS
...
without ecosystem adoption beyond Cisco).
...
EIGRP: **not supported on Arista**.  Cross-vendor migration drops
EIGRP entirely; operator must replan with OSPF or BGP.
...
- Cisco IOS-XE: top-of-file Limitations docstring states
