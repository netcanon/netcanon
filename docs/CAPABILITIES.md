...
| `cisco_nxos`      | Cisco NX-OS  | `show running-config` text | bidirectional | experimental (Phases 1–2b — L1/L3 basics + L2 switchport/LAG + SNMP/local-users; HSRP / VXLAN land in Phases 2c–4) |
