...
| `cisco_nxos`      | Cisco NX-OS  | `show running-config` text | bidirectional | best_effort (Phase 2 complete — L1/L3 basics + L2 switchport/LAG + SNMP/users + HSRP; per-VRF static / VXLAN-EVPN land in Phases 3–4) |
