...
See `netcanon/definitions/schema.py` for the authoritative Pydantic models:
...
because `netcanon/storage/file_store.py` builds backup filenames as
...
parser lives at `netcanon/collectors/probe.py` for unit-testable
