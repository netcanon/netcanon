...
**See also:** `CROSS_MESH_RESULTS.md` (next to this file) for the
cross-vendor translation fidelity matrix — every (source fixture,
target codec) round-trip with per-canonical-field drift.  This file
covers source-side parse fidelity; that file covers target-side
translation fidelity.  Generated by `tools/run_full_mesh.py`.
