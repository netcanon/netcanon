...
_NON_SENSITIVE: dict[tuple[str, str], tuple[str, str]] = {
    ...
    ("CanonicalSNMPv3User", "auth_kind"): ("METADATA", "USM key provenance marker read from the source line"),
    ...
    ("CanonicalSNMPv3User", "priv_kind"): ("METADATA", "USM key provenance marker read from the source line"),
