...
```python
from netconfig.migration.canonical.port_names import build_port_rename_transform
...
5. **UI surface.**  Add a rename rail in `netconfig/templates/migrate.html`
   and a per-pane endpoint in `netconfig/api/routes/migration.py`
