"""
Helpers extracted from :mod:`netconfig.api.routes.migration` for the
...
:mod:`netconfig.services.migration_pipeline` — they live one layer
...
def build_codec_info_list(vendors: dict) -> list[CodecInfo]:
    ...
    Returns:
        ...
        :func:`netconfig.migration.codecs.registry.list_codecs`, in
